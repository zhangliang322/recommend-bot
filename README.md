...
```powershell
$env:PYTHONPATH="src"
& "C:\Users\kai\.cache\codex-runtimes\codex-primary-runtime\dependencies\python\python.exe" -m product_reco_bot.cli run-demo
```
...
```powershell
& "C:\Users\kai\.cache\codex-runtimes\codex-primary-runtime\dependencies\python\python.exe" -m pytest
```
